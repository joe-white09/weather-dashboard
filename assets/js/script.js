...
function newSearch(cityName) {
    var forecastUrl = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityName + "&mode=json&appid=db90f37516c305d620d0e44557fd5bf2";
...
function getUvIndex(searchDataObj) {
    ...
    fetch(uvIndexUrl).then(function(response) {
        if (response.ok) {
            ...
            day1icon.setAttribute("src", "https://openweathermap.org/img/w/"+ data.daily[0].weather[0].icon + ".png");
